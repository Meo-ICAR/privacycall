...
class DataRemovalRequestApproved extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('Data Removal Request Approved: ' . $this->request->request_number)
            ->greeting('Hello,')
            ->line('A data removal request has been approved.')
            ...
            ->line('Due Date: ' . ($this->request->due_date?->format('Y-m-d') ?? 'N/A'))
            ->action('View Request', $url)
            ->line('Please proceed with the next steps.');
    }
