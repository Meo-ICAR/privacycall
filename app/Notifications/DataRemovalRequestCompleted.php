...
class DataRemovalRequestCompleted extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('Data Removal Request Completed: ' . $this->request->request_number)
            ->greeting('Hello,')
            ->line('A data removal request has been completed.')
            ...
            ->line('Completion Notes: ' . ($this->request->completion_notes ?? ''))
            ->action('View Request', $url)
            ->line('The request has been fully processed.');
    }
