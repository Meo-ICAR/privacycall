...
class DataRemovalRequestCancelled extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('Data Removal Request Cancelled: ' . $this->request->request_number)
            ->greeting('Hello,')
            ->line('A data removal request has been cancelled.')
            ...
            ->line('Cancellation Reason: ' . ($this->request->rejection_reason ?? ''))
            ->action('View Request', $url)
            ->line('The request has been cancelled.');
    }
