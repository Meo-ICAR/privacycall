...
@section('title', 'Create Disclosure Type')
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Create Disclosure Type</h1>
        </div>

        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('disclosure-types.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description"
                                  ...
                                  placeholder="Describe what this disclosure type covers...">{{ old('description') }}</textarea>
