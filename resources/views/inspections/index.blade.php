    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('inspections.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                                ...
                                <tr class="hover:bg-gray-50">
                                            ...
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div class="h-10 w-10 rounded-full bg-green-100 flex items-center justify-center">
                                                    <span class="text-sm font-medium text-green-800">
                                                        {{ strtoupper(substr($inspection->customer->first_name, 0, 1) . substr($inspection->customer->last_name, 0, 1)) }}
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">{{ $inspection->customer->first_name }} {{ $inspection->customer->last_name }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('inspections.show', $inspection) }}" class="text-blue-600 hover:text-blue-900" title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('inspections.edit', $inspection) }}" class="text-yellow-600 hover:text-yellow-900" title="Edit">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500 mb-6">Get started by adding your first inspection.</p>
