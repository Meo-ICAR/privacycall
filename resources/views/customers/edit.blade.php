        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Update customer information and GDPR compliance details</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="px-4 py-5 sm:p-6">
            <form action="{{ route('customers.update', $customer) }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('notes') border-red-500 @enderror">{{ old('notes', $customer->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="date" name="gdpr_consent_date" id="gdpr_consent_date"
                                       ...
                                       value="{{ old('gdpr_consent_date', $customer->gdpr_consent_date ? $customer->gdpr_consent_date->format('Y-m-d') : '') }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="data_processing_purpose" id="data_processing_purpose"
                                       ...
                                       value="{{ old('data_processing_purpose', $customer->data_processing_purpose) }}"
                            ...
                            <div>
                                ...
                                <input type="number" name="data_retention_period" id="data_retention_period"
                                       ...
                                       value="{{ old('data_retention_period', $customer->data_retention_period) }}"
                                       placeholder="365">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="consent_method" id="consent_method"
                                    ...
                                    <option value="web_form" {{ old('consent_method', $customer->consent_method) == 'web_form' ? 'selected' : '' }}>Web Form</option>
                                    <option value="email" {{ old('consent_method', $customer->consent_method) == 'email' ? 'selected' : '' }}>Email</option>
                                    <option value="phone" {{ old('consent_method', $customer->consent_method) == 'phone' ? 'selected' : '' }}>Phone</option>
                                    <option value="in_person" {{ old('consent_method', $customer->consent_method) == 'in_person' ? 'selected' : '' }}>In Person</option>
                                    <option value="document" {{ old('consent_method', $customer->consent_method) == 'document' ? 'selected' : '' }}>Document</option>
                                    <option value="app_notification" {{ old('consent_method', $customer->consent_method) == 'app_notification' ? 'selected' : '' }}>App Notification</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select name="consent_source" id="consent_source"
                                    ...
                                    <option value="website" {{ old('consent_source', $customer->consent_source) == 'website' ? 'selected' : '' }}>Website</option>
                                    <option value="mobile_app" {{ old('consent_source', $customer->consent_source) == 'mobile_app' ? 'selected' : '' }}>Mobile App</option>
                                    <option value="call_center" {{ old('consent_source', $customer->consent_source) == 'call_center' ? 'selected' : '' }}>Call Center</option>
                                    <option value="in_store" {{ old('consent_source', $customer->consent_source) == 'in_store' ? 'selected' : '' }}>In Store</option>
                                    <option value="email_campaign" {{ old('consent_source', $customer->consent_source) == 'email_campaign' ? 'selected' : '' }}>Email Campaign</option>
                                    <option value="contract" {{ old('consent_source', $customer->consent_source) == 'contract' ? 'selected' : '' }}>Contract</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select name="consent_channel" id="consent_channel"
                                    ...
                                    <option value="online" {{ old('consent_channel', $customer->consent_channel) == 'online' ? 'selected' : '' }}>Online</option>
                                    <option value="offline" {{ old('consent_channel', $customer->consent_channel) == 'offline' ? 'selected' : '' }}>Offline</option>
                                    <option value="phone" {{ old('consent_channel', $customer->consent_channel) == 'phone' ? 'selected' : '' }}>Phone</option>
                                    <option value="email" {{ old('consent_channel', $customer->consent_channel) == 'email' ? 'selected' : '' }}>Email</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select name="consent_evidence" id="consent_evidence"
                                    ...
                                    <option value="screenshot" {{ old('consent_evidence', $customer->consent_evidence) == 'screenshot' ? 'selected' : '' }}>Screenshot</option>
                                    <option value="document" {{ old('consent_evidence', $customer->consent_evidence) == 'document' ? 'selected' : '' }}>Document</option>
                                    <option value="audio_recording" {{ old('consent_evidence', $customer->consent_evidence) == 'audio_recording' ? 'selected' : '' }}>Audio Recording</option>
                                    <option value="video_recording" {{ old('consent_evidence', $customer->consent_evidence) == 'video_recording' ? 'selected' : '' }}>Video Recording</option>
                                    <option value="email_confirmation" {{ old('consent_evidence', $customer->consent_evidence) == 'email_confirmation' ? 'selected' : '' }}>Email Confirmation</option>
                                    <option value="digital_signature" {{ old('consent_evidence', $customer->consent_evidence) == 'digital_signature' ? 'selected' : '' }}>Digital Signature</option>
                                </select>
                            ...
                            <div>
                                ...
                                @if($customer->consent_evidence_file)
                                    <p class="mt-1 text-sm text-gray-600">Current file: {{ basename($customer->consent_evidence_file) }}</p>
                                @endif
                            ...
                            <div>
                                ...
                                <input type="text" name="consent_version" id="consent_version"
                                       ...
                                       value="{{ old('consent_version', $customer->consent_version) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="consent_language" id="consent_language"
                                       ...
                                       value="{{ old('consent_language', $customer->consent_language) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="user_agent" id="user_agent"
                                       ...
                                       value="{{ old('user_agent', $customer->user_agent) }}">
                                @error('user_agent')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="consent_text" id="consent_text" rows="4"
                                      ...
                                      placeholder="Enter the exact consent text that was presented to the customer">{{ old('consent_text', $customer->consent_text) }}</textarea>
                            @error('consent_text')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex items-center">
                            <input type="checkbox" name="data_processing_consent" id="data_processing_consent" value="1"
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                                   {{ old('data_processing_consent', $customer->data_processing_consent) ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="third_party_sharing_consent" id="third_party_sharing_consent" value="1"
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                                   {{ old('third_party_sharing_consent', $customer->third_party_sharing_consent) ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="data_retention_consent" id="data_retention_consent" value="1"
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                                   {{ old('data_retention_consent', $customer->data_retention_consent) ? 'checked' : '' }}>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex items-center">
                            <input type="checkbox" name="right_to_be_forgotten_requested" id="right_to_be_forgotten_requested" value="1"
                                   ...
                                   {{ old('right_to_be_forgotten_requested', $customer->right_to_be_forgotten_requested) ? 'checked' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="date" name="right_to_be_forgotten_date" id="right_to_be_forgotten_date"
                                   ...
                                   value="{{ old('right_to_be_forgotten_date', $customer->right_to_be_forgotten_date ? $customer->right_to_be_forgotten_date->format('Y-m-d') : '') }}">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="data_portability_requested" id="data_portability_requested" value="1"
                                   ...
                                   {{ old('data_portability_requested', $customer->data_portability_requested) ? 'checked' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="date" name="data_portability_date" id="data_portability_date"
                                   ...
                                   value="{{ old('data_portability_date', $customer->data_portability_date ? $customer->data_portability_date->format('Y-m-d') : '') }}">
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <h4 class="text-md font-medium text-gray-800 mb-3">GDPR Status Summary</h4>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        <div class="flex items-center">
                            <span class="w-3 h-3 rounded-full mr-2 {{ $customer->hasValidGdprConsent() ? 'bg-green-500' : 'bg-red-500' }}"></span>
                            <span class="text-gray-700">Consent Valid: {{ $customer->hasValidGdprConsent() ? 'Yes' : 'No' }}</span>
                        </div>
                        <div class="flex items-center">
                            <span class="w-3 h-3 rounded-full mr-2 {{ $customer->hasRequestedRightToBeForgotten() ? 'bg-red-500' : 'bg-green-500' }}"></span>
                            <span class="text-gray-700">Right to be Forgotten: {{ $customer->hasRequestedRightToBeForgotten() ? 'Requested' : 'Not Requested' }}</span>
                        </div>
                        <div class="flex items-center">
                            <span class="w-3 h-3 rounded-full mr-2 {{ $customer->hasRequestedDataPortability() ? 'bg-yellow-500' : 'bg-green-500' }}"></span>
                            <span class="text-gray-700">Data Portability: {{ $customer->hasRequestedDataPortability() ? 'Requested' : 'Not Requested' }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                    <a href="{{ route('customers.show', $customer) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
